...
from research.forms import PromptForm
...
def workspace(request):
    if request.method == "GET":
        return render(request, "research/workspace.html", {"form": PromptForm()})
...
def report_detail(request, id):
    ...
    return render(request, "research/report.html", {"report": saved.report_data, "saved": saved})


def comparison(request):
    return render(request, "research/comparison.html")
...
def screener(request):
    ...
    return render(request, "research/screener.html", {"query": query, "results": results})


def dashboard(request):
    return render(request, "research/dashboard.html", {"report_count": SavedReport.objects.count()})


def watchlist(request):
    return render(request, "research/watchlist.html")


def saved_reports(request):
    return render(request, "research/saved_reports.html", {"reports": SavedReport.objects.all()})
