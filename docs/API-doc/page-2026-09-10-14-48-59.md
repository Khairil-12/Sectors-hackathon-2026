# News Tags - Sectors Financial API
...
fetch('https://api.sectors.app/v2/tags/', options)
  .then(res => res.json())
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://api.sectors.app/v2/tags/",
...
```
HttpResponse<String> response = Unirest.get("https://api.sectors.app/v2/tags/")
  .header("Authorization", "<api-key>")
  .asString();
```
...
url = URI("https://api.sectors.app/v2/tags/")
